...
const ProductDetails: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className='bg-gray-100 pt-4 pb-4'
    >
      <motion.section
        className="py-2 lg:py-4 relative"
        variants={fadeInVariant}
        transition={{ delay: 0.2, duration: 0.6 }}
      >
        <div className="mx-auto max-w-[90%] px-4 sm:px-4 lg:px-4">
          <motion.div
            className="grid grid-cols-1 lg:grid-cols-2 pb-8 gap-8 lg:gap-16"
            variants={fadeInVariant}
            transition={{ delay: 0.3, duration: 0.6 }}
          >
            <motion.div
              className="pro-detail w-full flex flex-col justify-center order-last lg:order-none max-lg:max-w-[608px] max-lg:mx-auto"
              variants={fadeInVariant}
              transition={{ delay: 0.4, duration: 0.6 }}
            >
              <motion.div variants={fadeInVariant} transition={{ delay: 0.5 }}>
                <Breadcrumbs />
              </motion.div>
              <motion.h2
                className="mb-2 font-manrope font-bold text-3xl leading-10 text-gray-900"
                variants={fadeInVariant}
              ...
              <motion.p
                className="text-gray-500 text-base font-normal mb-8"
                variants={fadeInVariant}
        ...
        <motion.div
          className="flex pt-3 flex-wrap gap-4 mx-auto max-w-[90%] px-4 sm:px-4 lg:px-4"
          variants={fadeInVariant}
          initial="hidden"
          animate="visible"
