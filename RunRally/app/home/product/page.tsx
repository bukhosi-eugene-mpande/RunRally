  ...
  const mockProducts: Product[] = [
    {
      ...
      detail: "Adjustable, sweat-resistant armband to hold your smartphone while running. Compatible with most smartphone sizes.",
      price: 199.99,
    ...
    },
    {
      ...
      detail: "Made with moisture-wicking fabric to keep you cool and dry during your run. Available in multiple colors and sizes.",
      price: 299.99,
      images: ["/product/shirt/shirt1.png", "/product/shirt/shirt2.png", "/product/shirt/shirt3.png"],
      rating: 4
    },
    {
      id: "3",
      ...
      detail: "BPA-free, 20 oz capacity with a convenient flip-top lid. Perfect for staying hydrated on long runs.",
      price: 129.99,
      images: ["/product/bottle/bottle1.avif", "/product/bottle/bottle2.jpg", "/product/bottle/bottle3.jpg"],
      rating: 4
    },
    {
      id: "4",
      ...
      detail: "Adjustable cap with UPF 50+ sun protection. Features a moisture-wicking sweatband and reflective elements for visibility.",
      price: 249.99,
    ...
    },
    {
      ...
      detail: "Bluetooth 5.0, 8-hour battery life, and secure-fit ear hooks. Ideal for music and podcasts while running.",
      price: 799.99,
    ...
    },
    {
      ...
      detail: "Tracks steps, distance, pace, and heart rate. Features GPS, sleep monitoring, and smartphone notifications.",
      price: 1499.99,
      images: ["/product/fitbit/fitbit1.jpg", "/product/fitbit/fitbit2.avif", "/product/fitbit/fitbit3.avif", "/product/fitbit/fitbit4.webp"],
      rating: 4
    },
    {
      id: "7",
      ...
      detail: "Perfect for chilly morning runs. Windproof front panel, breathable back, and multiple pockets for storage.",
      price: 599.99,
      images: ["/product/vest/runningvest1.png", "/product/vest/runningvest2.png", "/product/vest/runningvest3.png"],
      rating: 4
    },
    {
      id: "8",
      ...
      detail: "Reflective strips for enhanced visibility during low-light conditions. Lightweight and breathable design.",
      price: 349.99,
      images: ["/product/workvest/workvest1.jpg", "/product/workvest/workvest2.jpg", "/product/workvest/workvest3.jpg"],
      rating: 4
    }
  ];
  ...
  return (
    <section className="py-2 lg:py-4 relative">
      <div className="mx-auto max-w-[90%] px-4 sm:px-4 lg:px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="pro-detail w-full flex flex-col justify-center order-last lg:order-none max-lg:max-w-[608px] max-lg:mx-auto">
            ...
            <h2 className="mb-2 font-manrope font-bold text-3xl leading-10 text-gray-900">{selectedProduct.name}</h2>
            <div className="flex flex-col sm:flex-row sm:items-center mb-6">
              <h6 className="font-manrope font-semibold text-2xl leading-9 text-gray-900 pr-5 sm:border-r border-gray-200 mr-5">R{selectedProduct.price}</h6>
              <div className="flex items-center gap-2">
                ...
                <span className="pl-2 font-normal leading-7 text-gray-500 text-sm">10 reviews</span>
              </div>
            </div>
              ...
              <div className="text">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                  ...
                  <button className="group py-4 px-5 rounded-full bg-green-50 text-green-600 font-semibold text-lg w-full flex items-center justify-center gap-2 shadow-sm shadow-transparent transition-all duration-500 hover:bg-green-100 hover:shadow-green-200">
                    <svg className="stroke-green-600 transition-all duration-500" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                  ...
                  <button className="group transition-all duration-500 p-4 rounded-full bg-green-50 hover:bg-green-100 hover:shadow-sm hover:shadow-green-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                      <path
                        ...
                        stroke="#16a34a" strokeWidth="1.6" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"
                      />
                    </svg>
                  </button>
      ...
      <div className="flex pt-3 flex-wrap gap-4 mx-auto max-w-[90%] px-4 sm:px-4 lg:px-4">
        <ProductTabs description={selectedProduct.description} details={selectedProduct.detail} />
      </div>
    </section>
  );
};
