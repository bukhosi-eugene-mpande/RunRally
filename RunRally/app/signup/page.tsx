...
export default function SignIn() {
  ...
  const validatePassword = (password: string) => {
    ...
    if (!/[A-Z]/.test(password) || !/[a-z]/.test(password)) {
      errors.push('Include uppercase and lowercase letters (e.g., A, B, c, d).');
    }
    if (!/[0-9]/.test(password) || !/[!@#$%^&*]/.test(password)) {
      errors.push('Include numbers and special characters (e.g., 1, 2, 3, !, @, #, $).');
    }
    return errors;
  };
      ...
      <div className="relative">
        ...
        <div>
          ...
          <div className="flex items-center w-full max-w-xl px-3 mx-auto lg:w-2/6">
            <div className="flex-1 rounded-2xl bg-gray-500 bg-opacity-55 p-7 m-auto">
              ...
              <div className="mt-8">
                <form>
                    ...
                    {emailStart && (
                      isValid ? (
                        <p className="mt-2 text-md font-bold text-green-600 dark:text-green-500">
                          <span className="font-extrabold">Well done!</span> Your email is valid.
                        </p>
                      ) : (
                        <p className="mt-2 text-md font-bold text-red-600 dark:text-red-500">
                          <span className="font-extrabold">Oh, snap!</span> Please enter a valid email address.
                        </p>
                      )
                    )}
                  </div>
                  ...
                  <div>
                    <div className="mt-6">
                      ...
                      <ul className="mt-2 text-sm font-bold text-white list-disc list-inside">
                        <li>Your password should be least 12 characters long</li>
                        <li>Include uppercase and lowercase letters (e.g., <span className="font-extrabold">A, B, c, d</span>)</li>
                        <li>Include numbers and special characters (e.g., <span className="font-extrabold">1, 2, 3</span> <span className="font-bold">!, @, #, $</span>)</li>
                      </ul>
                      {passwordStart && errors.length > 0 && (
                        <div className="mt-2 text-md font-bold text-red-600 dark:text-red-500">
                          {errors.map((error, index) => (
                            <p key={index}><span className="font-extrabold">Oh, snap!</span> {error}</p>
                          ))}
                        </div>
                      )}
                    </div>
                ...
                <div className="py-3 flex items-center text-xs text-white uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6">Or</div>
                ...
                >
                  <svg className="shrink-0 size-4" fill="#000000" viewBox="-52.01 0 560.035 560.035" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <svg className="shrink-0 size-5" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="none">
