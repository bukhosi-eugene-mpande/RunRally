          ...
          <div className="flex items-center w-full max-w-md px-3 mx-auto lg:w-2/6">
            <div className="flex-1 rounded-2xl bg-gray-500 bg-opacity-40 p-7 m-auto">
              ...
              <div className="mt-8">
                ...
                <button type="button" className="py-2 m-2 px-3 w-full inline-flex justify-center items-center gap-x-2 text-md font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">
