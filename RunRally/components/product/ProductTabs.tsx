  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-3 p-4">
        <div id="basic-tabs-1" role="tabpanel" aria-labelledby="basic-tabs-item-1" className={activeTab === 'basic-tabs-1' ? '' : 'hidden'}>
            <DescriptionTab descrip={description} det={details} />
        </div>
        <div id="basic-tabs-2" role="tabpanel" aria-labelledby="basic-tabs-item-2" className={activeTab === 'basic-tabs-2' ? '' : 'hidden'}>
            <ReviewTab /> 
        </div>
      </div>
    </div>
