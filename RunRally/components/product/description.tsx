    ...
    <section className="py-4 sm:py-4 text-black">
      <div className="p-2">
        <div className="mt-2 flow-root sm:mt-2">
          ...
          <p className="mt-4">{descrip}</p>
        </div>
      </div>
      <div className="p-2">
        <div className="mt-2 flow-root sm:mt-2">
          <h1 className="text-3xl font-bold">Details</h1>
          <p className="mt-4">{det}</p>
        </div>
      </div>
      <div>
        <div className="p-2">
          <div className="border-t border-b py-4 mt-7 border-gray-200">
            ...
            >
              ...
              >
                <svg
                  className={`transform ${isShippingVisible ? 'rotate-180' : ''}`}
                  width="10"
                  height="6"
                  viewBox="0 0 10 6"
                  fill="none"
            ...
            <div
              className={`pt-4 text-base leading-normal pr-12 mt-4 ${isShippingVisible ? '' : 'hidden'}`}
              id="sect"
            >
        ...
        <div className="p-2">
          <div className="border-b py-4 border-gray-200">
            ...
            >
              ...
              >
                <svg
                  className={`transform ${isContactVisible ? 'rotate-180' : ''}`}
                  width="10"
                  height="6"
                  viewBox="0 0 10 6"
                  fill="none"
            ...
            <div
              className={`pt-4 text-base leading-normal pr-12 mt-4 ${isContactVisible ? '' : 'hidden'}`}
              id="sect"
            >
